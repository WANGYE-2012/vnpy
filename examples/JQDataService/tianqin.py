...
download_tasks["T_tick"] = DataDownloader(api, symbol_list=["DCE.c2005"], dur_sec=0,
                    start_dt=datetime(2019, 5, 1), end_dt=datetime(2020, 3, 22), csv_file_name="c2005_tick.csv")
